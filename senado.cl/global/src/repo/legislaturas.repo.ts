...
import {S3Location, S3ParamsRepo, S3SimpleRepo} from "@open-data-scraping/commons/dist";
...
@S3Location({ bucket: MainBucketKey.S3_BUCKET, keyTemplate: LegislaturasBucketKey.distilledJson })
