...
import {ProyectosMapRaw, ProyectoRaw, ProyectosMapDtl} from "../model";
...
@S3Location({ bucket: MainBucketKey.S3_BUCKET, keyTemplate: ProyectosBucketKey.dtlMap })
export class ProyectosMapDtlRepo extends S3SimpleRepo<ProyectosMapDtl> {}
